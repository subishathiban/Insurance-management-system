...
<title><?php echo WBName; ?> - Apprved Policy Holders</title>
...
Approved Policy Holders
</h3>
<a class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" href="staff?page=applications">All</a>&nbsp;
<a class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" href="staff?page=pending_applications">Pending</a>&nbsp;
<a class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" href="staff?page=approved_applications">Approved</a>&nbsp;
<a class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" href="staff?page=denied_applications">Denied</a>&nbsp;
</div>
...
$download = 1;
?>
<a class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" href="staff/core/download-policy?id=<?php echo $row[0]; ?>">
Download
</a>
<?php
}
