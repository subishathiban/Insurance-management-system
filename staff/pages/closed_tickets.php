...
$stmt = $conn->prepare("SELECT * FROM tbl_tickets LEFT JOIN tbl_ticket_categories ON tbl_tickets.category = tbl_ticket_categories.id LEFT JOIN tbl_users ON tbl_tickets.member_id = tbl_users.id WHERE tbl_tickets.status = '2' AND tbl_tickets.assigned_to = ? ORDER BY tbl_tickets.id");
...
<div class="modal-content">
<form id="app_frm2" action="staff/core/assign_user" method="POST" autocomplete="off">
<div class="modal-header">
...
<div class="modal-dialog modal-lg" role="document">
<div class="modal-content">
<form id="app_frm3" action="staff/core/add_remark" method="POST" autocomplete="off">
<div class="modal-header">
