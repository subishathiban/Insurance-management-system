...
<form id="app_frm" action="admin/core/update_profile" method="POST" autocomplete="off">
<div class="row mb-2">
<div class="col-md-4">
<label class="form-label">First Name</label>
<input required value="<?php echo $fname; ?>" name="fname"  type="text" class="form-control form-control-alt">
</div>
<div class="col-md-4">
<label class="form-label">Last Name</label>
<input required value="<?php echo $lname; ?>" name="lname"  type="text" class="form-control form-control-alt">
</div>
<div class="col-md-4">
<label class="form-label">Gender</label>
<select required name="gender"  class="form-control form-control-alt">
...
<input required value="<?php echo $phone; ?>" name="phone"  type="text" class="form-control form-control-alt">
</div>

<div class="mb-3 col-md-4">
<label class="form-label">Email</label>
<input required value="<?php echo $email; ?>" name="email"  type="email" class="form-control form-control-alt">
</div>
...
<form id="load100" action="admin/core/update_password" method="POST" autocomplete="off">
<div class="row push">
<div class="col-lg-12">
<p class="text-muted">
