...
<link rel="shortcut icon" href="assets/media/favicons/favicon.ico" type="image/x-icon">
...
<p class="mb-0">Welcome to admin panel <?php print ''.$fname.'!'; ?></p>
</div>
</div>

<div class="row">
<div class="col-md-3">
<a class="block block-rounded block-link-shadow" href="admin?page=applications">
...
<div class="col-md-3">
<a class="block block-rounded block-link-shadow" href="admin?page=pending_applications">
<div class="block-content block-content-full">
<div class="py-4 text-center">
<div class="mb-3">
...
<div class="col-md-3">
<a class="block block-rounded block-link-shadow" href="admin?page=approved_applications">
<div class="block-content block-content-full">
<div class="py-4 text-center">
<div class="mb-3">
...
<div class="col-md-3">
<a class="block block-rounded block-link-shadow" href="admin?page=closed_tickets">
<div class="block-content block-content-full">
<div class="py-4 text-center">
<div class="mb-3">
