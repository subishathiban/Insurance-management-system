...
<title><?php echo WBName; ?> - Insurance Categories</title>
...
<a class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" onclick="return confirm('Are you sure you want to delete <?php echo $row[1]; ?> category?');" href="admin/core/drop-category?id=<?php echo $row[0]; ?>">
...
<div class="modal-dialog" role="document">
<div class="modal-content">
<form id="app_frm2" action="admin/core/update_category" method="POST" autocomplete="off">
<div class="modal-header">
