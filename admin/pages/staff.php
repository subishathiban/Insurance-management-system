...
<title><?php echo WBName; ?> - Staff</title>
...
<td class="text-center">
<div class="btn-group">
<button onclick="set_user('<?php echo $row[0]; ?>','<?php echo $row[1]; ?>','<?php echo $row[2]; ?>','<?php echo $row[7]; ?>','<?php echo $row[3]; ?>','<?php echo $row[4]; ?>','<?php echo $row[10]; ?>');" type="button" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" data-bs-toggle="modal" data-bs-target="#modal-default-fadein2" data-bs-keyboard="false" data-bs-backdrop="static">
<i class="fa fa-pencil-alt"></i>
</button>
<a class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" onclick="return confirm('Are you sure you want to delete <?php echo $row[1]; ?>?');" href="admin/core/drop-staff?id=<?php echo $row[0]; ?>">
...
<form id="app_frm" action="admin/core/new_staff" method="POST" autocomplete="off">
...
<div class="col-sm-8">
<input name="fname" required type="text" class="form-control form-control-alt" placeholder="Enter first name">
</div>
</div>
<div class="row mb-2">
<label class="col-sm-4 col-form-label">Last Name</label>
<div class="col-sm-8">
<input name="lname" required type="text" class="form-control form-control-alt" placeholder="Enter last name">
</div>
</div>
<div class="row mb-2">
<label class="col-sm-4 col-form-label">Email</label>
<div class="col-sm-8">
<input name="email" required type="email" class="form-control form-control-alt" placeholder="Enter email address">
</div>
</div>
<div class="row mb-2">
...
<div class="col-sm-8">
<input name="phone" required type="text" class="form-control form-control-alt" placeholder="Enter mobile phone">
</div>
</div>
...
<div class="modal-dialog" role="document">
<div class="modal-content">
<form id="app_frm3" action="admin/core/update_staff" method="POST" autocomplete="off">
<div class="modal-header">
...
<div class="modal-dialog" role="document">
<div class="modal-content">
<form id="app_frm2" enctype="multipart/form-data" action="admin/core/import_staff" method="POST" autocomplete="off">
<div class="modal-header">
...
Download excel template from <a download href="templates/import_staff.xlsx" class="alert-link">here</a>, fill staff information then upload it through the form below.
</div>
</div>
</div>
...
<div class="modal-footer">
<button type="button" class="btn btn-alt-secondary" data-bs-dismiss="modal">Close</button>
<button id="sub_btn2" type="submit" class="btn  btn-primary">Upload</button>
</div>
</form>
</div>
</div>
...
<script>
function set_user(id, fname, lname, email, gender, phone, status) {
